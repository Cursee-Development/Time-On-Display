...
import com.cursee.time_on_display.TimeOnDisplayNeoForge;
...
public class TimeOnDisplayOverlayNeoForge implements LayeredDraw.Layer {
  ...
  */
  ...
  // initialize resources
	...
	public void render(GuiGraphics graphics, DeltaTracker deltaTracker) {
		...
		if (displayEnabled && TimeOnDisplayNeoForge.displayToggle) {
	...
	// define overlay
//	public static final IGuiOverlay HUD_TIME = ((forgeGui, guiGraphics, partialTick, pX, pY) -> {
//
//		final int x = guiGraphics.guiWidth();
//		final int y = guiGraphics.guiHeight();
//
//		// gather config
//		final boolean ENABLE = NeoForgeConfig.ENABLE.get();
//		final boolean SYSTEM_TIME_ONLY = NeoForgeConfig.SYSTEM_TIME_ONLY.get();
//		final boolean DISPLAY_CLOCK_ICONS = NeoForgeConfig.DISPLAY_CLOCK_ICONS.get();
//		final boolean DISPLAY_24_HOUR = NeoForgeConfig.DISPLAY_24_HOUR.get();
//		final String DISPLAY_LOCATION = NeoForgeConfig.DISPLAY_LOCATION.get();
//		final String DISPLAY_ICON = NeoForgeConfig.DISPLAY_ICON.get();
//
//		if (ENABLE && TimeOnDisplayNeoForge.keyToggle) {
//
